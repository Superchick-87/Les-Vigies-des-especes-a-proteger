                ...
                for (let i = 0; i <= tableau.length - 1; i++) {
                    ...
                    for (let j = 0; j <= tableau[i].cdref.length - 1; j++) {
                        ...
                        mat[i].innerHTML +=
                            ...
                            // // "<img class='w visu' src='" + data2?._embedded?.media[0]?._links?.file.href + "'>" +
